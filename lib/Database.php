    ...
    class booking_package_database {
        ...
        public function __construct($prefix, $db_version){
			...
			$this->db_list[$table_name] = "CREATE TABLE ".$table_name." (
				                        	...
				                        	`idForGoogleWebhook`					VARCHAR(255) DEFAULT NULL, 
				                        	...
				                        	`subscriptionIdForStripe`				VARCHAR(255) DEFAULT '', 
				                        	`enableSubscriptionForStripe`			INT(11) DEFAULT 0, 
				                        	`termsOfServiceForSubscription`			VARCHAR(255) DEFAULT '', 
				                        	`enableTermsOfServiceForSubscription`	INT(11) DEFAULT 0, 
				                        	`privacyPolicyForSubscription`			VARCHAR(255) DEFAULT '', 
				                        	...
				                        	`displayRemainingCapacityHasMoreThenThreshold`	VARCHAR(255) DEFAULT '', 
				                        	`displayRemainingCapacityHasLessThenThreshold`	VARCHAR(255) DEFAULT '', 
				                        	`displayRemainingCapacityHas0`			VARCHAR(255) DEFAULT '', 
				                        	'startOfWeek'							INT(11) DEFAULT 0,
				                        	'ical'									INT(1) DEFAULT 0,
				                        	'icalToken'								VARCHAR(255) DEFAULT '0',
				                        	UNIQUE KEY id (`key`)
				                        	) $charset_collate;";
